...
export default function ListDoctorTHT({navigation, onPress, name, profession}) {
  const dokterAnakData = JSONDoctor.data.filter(
    doctor => doctor.profession === 'Dokter THT',
  );
  return (
    <View style={styles.page}>
      <View style={styles.wrappertitle}>
        ...
        <View>
          ...
          <Text style={styles.title}>Pilih Dokter THT</Text>
        </View>
      </View>
      <ScrollView>
